...
//ug_input = document.createElement('input');
//meio.appendChild(ug_input);
//ug_input.name = 'unidade_gestora_input';
//ug_input['list'] = 'unidades_gestoras';
...
unidade_gestora = document.createElement('select');
unidade_gestora.id = "unidade_gestora";
meio.appendChild(unidade_gestora);

for(var i=0; i<unidades.length; i++){
  unidade = document.createElement('option');
  unidade.value = unidades[i];
  unidade.textContent = unidades[i];
  unidade_gestora.appendChild(unidade);
}
